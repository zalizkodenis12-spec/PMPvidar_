(() => {
  ...
  const catalogData = {
    ...
    3: {
      ...
      items: [
        { name: 'Спирти технічні', desc: 'Бутанол / Гліцерин / Бутилгліколь / Етанол / ДЕА', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-14 235941.png' },
        { name: 'Розчинники в асортименті', desc: 'Імпортні наливом і фасовці', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-14 235956.png' },
        { name: 'Автошини', desc: 'Легкових ТЗ і вантажного та с/г транспорту', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-15 000052.png' },
        { name: 'Спирти хімія в асортименті', desc: 'Кислоти / Ефіри / Лаки / Емалі / Добавки харчові', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-15 000148.png' },
        { name: 'Сипуча хімія та добрива', desc: 'В асортименті', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-15 000304.png' },
        { name: 'Розчинники різні та припої', desc: 'В асортименті', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-15 000451.png' },
        { name: 'Метали, сплави і припої', desc: 'В асортименті', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-15 000535.png' },
        { name: 'Промислова хімія', desc: 'В асортименті імпортна', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-15 000639.png' },
        { name: 'СТО — Шиномонтаж та заміна масел', desc: 'Шиномонтаж, ремонт ходової, заправка кондиціонера', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-11 152019.png' },
        { name: 'Комп\'ютерна діагностика', desc: 'Діагностика легкових, вантажних авт. та с/г техніки', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-11 151830.png' },
        { name: 'Обслуговування рефрижераторів', desc: 'Легкові і вантажні авт. / с/г техніка та рефрижератор', price: 'За запитом', img: 'assets/images/Знімок екрана 2026-07-11 151727.png' },
        { name: 'Прийом відпрацьованого масла', desc: 'Забирають відпрацьоване масло', price: 'Безкоштовно', img: 'assets/images/Знімок екрана 2026-07-15 001046.png' },
      ]
    }
  };
